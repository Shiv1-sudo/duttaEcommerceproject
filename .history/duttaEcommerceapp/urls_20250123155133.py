...
from .views.tech_connect_view import TechConnectView
from .views.jobseekerview import JobSeeker, submit_comment
from .views.jobseeker_dashborad_view import dashboard
...
from .views.tech_services_view import tech_services
from .views.game_view import dsa_game,submit_dsa_answer,game_result
...
urlpatterns = [
    ...
    path('tech_connect/', TechConnectView.as_view(), name='tech_connect'),
    path('job_seekers/', JobSeeker.as_view(), name='job_seekers'),
    path('submit_comment/<int:user_id>/', submit_comment, name='submit_comment'),
    path('dashboard/',dashboard,name='dashboard'),
    path('tech_services/',tech_services,name='tech_services'),
    path('dsa_game/',dsa_game,name='dsa_game'),
    path('submit_dsa_answer/',submit_dsa_answer,name='submit_dsa_answer'),
    path('game_result/',game_result,name='game_result'),
]
